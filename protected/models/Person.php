...
class Person extends BaseModel{
    ...
    public function rules() {
        return array(
            array('FirstName, LastName, BarcodeID, Household, Type', 'required'),
            ...
            array('DateOfBirth', 'application.extensions.Validators.ClientDateTime'),
          ...
          //  array('HomePhone, WorkPhone, MobilePhone, PhysicianPhoneNumber', 'match', 'pattern' => '/^\(\d{3}\)\d{3}-\d{4}$/', 'message'=>'Phone number has incorrect format'),
            ...
            array('GDocSurvey, GDocApplication', 'application.extensions.Validators.Link', 'type' => LinkType::GOOGLE_DOCS),
    ...
    public function relations(){
        return array(
            ...
            'CMUserProfileRelation' => array(self::HAS_ONE, 'CMUserProfile', 'PersonId'),
        );
    }
